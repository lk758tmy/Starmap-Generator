...
/*Not waste time for checking new_height if it doesn't
...
bool try_once(){
    ...
    do{//Part II: Random Hill-Climbing
        ...
        /*12000000 was a good limit to reach 62/64 
          before I discovered that new_h==height is also
    ...
    }while(cnt_2<600); //Need a limit for safety.
    return false;
}
