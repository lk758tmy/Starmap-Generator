...
void _print(unsigned int seed){//Print the starmap to the file.
	FILE *fp = fopen("SOut.txt", "a");
	printf("Seed: %ud\n",seed);
	for(int i=1;i<33;i++){
...
int main() {
	...
	printf("Please check \"SOut.txt\" for the result.");
	getchar(); getchar();
	return 0;
}